...
urlpatterns = [
	...
	path('contact_restaurant/', views.contact_restaurant, name='contact_restaurant'),
	path('my_account/', views.my_account, name='my_account'),
	path('profile/<username>/', views.ProfileView.as_view(), name='profile'),
	path('profile_restaurant/<username>/', views.ProfileView_restaurant.as_view(), name='profile_restaurant'),
